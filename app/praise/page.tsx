  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", gap:20 }}>
      ...
      <div className="hy-card" style={{ padding:"16px 18px", border:"1.5px solid #bbf7d0", background:"#f0fdf4" }}>
        ...
        <p style={{ fontSize:12, color:"#166534", lineHeight:1.75, margin:"0 0 8px" }}>
          이 기록은 생활기록부 문장을 만들어 내기 위한 칭찬 경쟁이 아닙니다. 선생님이 평소 교실에서 미처 보지 못한
          여러분의 모습과 서로의 좋은 행동을 알아가기 위한 공간입니다.
        </p>
        <p style={{ fontSize:12, color:"#166534", lineHeight:1.75, margin:0 }}>
          작성한 내용이 생활기록부에 그대로 들어가는 것은 아니며, 선생님이 평소 모습과 다른 기록을 함께 살펴보고 필요한 경우
          사실을 확인한 뒤 참고합니다. 다른 사람의 이름을 사용하거나 사실과 다른 내용을 작성하면 기록의 신뢰가 무너질 수 있으므로
          반드시 자신의 이름으로 사실에 근거하여 작성해주세요.
        </p>
      </div>
