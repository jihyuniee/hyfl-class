...
const SUBJECT_COLOR: Record<string, { bg: string; color: string }> = {
  ...
  "중독":   { bg: "#fef3c7", color: "#d97706" },
  "심작":   { bg: "#ede9fe", color: "#7c3aed" },
  "문학":   { bg: "#fce7f3", color: "#db2777" },
  "고전읽기": { bg: "#ecfeff", color: "#0891b2" },
  "대수":   { bg: "#eff6ff", color: "#2563eb" },
  "인탐":   { bg: "#ecfdf5", color: "#059669" },
  "진로":   { bg: "#fff7ed", color: "#ea580c" },
  "중문":   { bg: "#fff1f2", color: "#e11d48" },
  "과탐":   { bg: "#f0fdf4", color: "#16a34a" },
  "HR/CA": { bg: "#f3f4f6", color: "#374151" },
};
